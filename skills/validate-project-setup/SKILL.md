...
| `docs/tacit-knowledge/topics.md` | present, OKF `Index` (controlled-term list), reviewed (not just the raw seed) | The topic CV — human-reviewed, not left as the raw seed output |
