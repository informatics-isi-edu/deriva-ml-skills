...
| `docs/tacit-knowledge/index.md` | present, `type: RetrievalIndex`, has `covers_through` | Derived retrieval index — do not hand-edit; rebuilt by `capture-tacit-knowledge` |
