...
| `docs/tacit-knowledge/retrieval-index.md` | present, `type: RetrievalIndex`, has `covers_through` | Derived retrieval index — do not hand-edit; rebuilt by `capture-tacit-knowledge` |
| `docs/domain/index.md` | present, `type: ConceptBundle` | Domain-background bundle root over the `type: Concept` docs for durable, non-episodic domain facts |
