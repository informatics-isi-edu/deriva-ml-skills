...
- **MUST be documented** in `tacit-knowledge.md` (via `capture-tacit-knowledge`).
...
- [`capture-tacit-knowledge`](../capture-tacit-knowledge/SKILL.md) — Document catalog-modifying scripts in `tacit-knowledge.md`.
