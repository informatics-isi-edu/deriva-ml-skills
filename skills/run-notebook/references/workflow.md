...
| Execution status stuck at "Running" | Notebook crashed without clean exit | Call `deriva_ml_abort_execution(hostname=..., catalog_id=..., execution_rid="...", reason="<explanation>")` to mark the run failed. |
