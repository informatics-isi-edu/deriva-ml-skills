...
| `run-notebook` | 1 | REMOVED-TOOL=1 |
| `write-hydra-config` | 1 | HIST-PROSE=1 |
...
- `api-naming-conventions/SKILL.md:176` **REMOVED-TOOL** — `deriva_ml_update_execution`
...
- `dataset-lifecycle/references/workflow.md:77` **REMOVED-TOOL** — `deriva_ml_abort_execution`
  > Call `deriva_ml_commit_execution` with the execution RID. (No need to call Python API `exe.commit_output_assets()` — dat
- `dataset-lifecycle/references/workflow.md:207` **HIST-PROSE** — `ADR-reference`
...
- `dataset-lifecycle/references/workflow.md:357` **REMOVED-TOOL** — `deriva_ml_create_execution`
  > deriva_ml_create_execution(hostname="data.example.org", catalog_id="1", workflow_rid="<workflow_rid>", description="..."
- `dataset-lifecycle/references/workflow.md:358` **REMOVED-TOOL** — `deriva_ml_start_execution`
...
- `troubleshoot-execution/SKILL.md:99` **HIST-PROSE** — `ADR-reference`
  > - Per ADR-0003, dataset mutations flip `current_version` to a dev label (`<last_release>.post1.devN`). Call `deriva_ml_r
...
- `work-with-assets/references/workflow.md:171` **REMOVED-TOOL** — `deriva_ml_abort_execution`
  > On failure: call `deriva_ml_abort_execution(hostname="data.example.org", catalog_id="1", execution_rid=...)` instead. Pi
